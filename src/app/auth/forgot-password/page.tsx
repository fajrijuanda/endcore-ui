    ...
    return (
        <div className="space-y-8">
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                ...
                <button type="submit" className="w-full bg-primary hover:bg-primary/90 text-black font-bold py-3 rounded-xl transition-all shadow-[0_0_15px_rgba(0,0,0,0.1)] dark:shadow-[0_0_15px_rgba(255,215,0,0.3)] hover:shadow-[0_0_25px_rgba(0,0,0,0.2)] dark:hover:shadow-[0_0_25px_rgba(255,215,0,0.5)] flex items-center justify-center gap-2">
